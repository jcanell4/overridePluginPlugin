 ...
 */
/**
 * @author of IOC changes: Josep Cañellas <jcanell4@ioc.cat> 
 */
...
class ap_manage {
    ...
    function refresh() {
        ...
        //[START: IOC]
        if(!property_exists($this->manager, "allowedRefresh") 
                ||  $this->manager->allowedRefresh){
        //[END: IOC] 
        ...
        //[START: IOC]
            ...
            if(is_callable(array($this->manager, "forceRefresh"), true)){
